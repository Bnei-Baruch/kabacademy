...
/* CUSTOM EDITS: added class names "maincontainer" "cctopcontainer" "ccbottomcontainer" and "fillerBar" to enable CSS color controls.
Added DIV containers with class names "ieShim" to fix rendering problems in IE7 
 */
...
if(topMaxRadius){newMainContainer=document.createElement("div");newMainContainer.setAttribute('class','newMainContainerT');newMainContainer.style.width=this.boxWidth+"px";newMainContainer.style.fontSize="1px";newMainContainer.style.overflow="hidden";newMainContainer.style.position="absolute";newMainContainer.style.paddingLeft=this.borderWidth+"px";newMainContainer.style.paddingRight=this.borderWidth+"px";newMainContainer.style.height=topMaxRadius+"px";newMainContainer.style.top=-topMaxRadius+"px";newMainContainer.style.left=-this.borderWidthL+"px";this.topContainer=this.shell.appendChild(newMainContainer);var ieShimTop=document.createElement("div");ieShimTop.setAttribute('class','ieShim');this.topContainer.appendChild(ieShimTop);}
if(botMaxRadius){var newMainContainer=document.createElement("div");newMainContainer.setAttribute('class','newMainContainerB');newMainContainer.style.width=this.boxWidth+"px";newMainContainer.style.fontSize="1px";newMainContainer.style.overflow="hidden";newMainContainer.style.position="absolute";newMainContainer.style.paddingLeft=this.borderWidthB+"px";newMainContainer.style.paddingRight=this.borderWidthB+"px";newMainContainer.style.height=botMaxRadius+"px";newMainContainer.style.bottom=-botMaxRadius+"px";newMainContainer.style.left=-this.borderWidthL+"px";this.bottomContainer=this.shell.appendChild(newMainContainer);var ieShimBottom=document.createElement("div");ieShimBottom.setAttribute('class','ieShim');this.bottomContainer.appendChild(ieShimBottom);}
...
this.topContainer.setAttribute('class','cctopcontainer');this.topContainer.appendChild(newFillerBar);}
...
this.bottomContainer.setAttribute('class','ccbottomcontainer');this.bottomContainer.appendChild(newFillerBar);}}}
...
curvyObject.prototype.drawPixel=function(intx,inty,colour,transAmount,height,newCorner,image,cornerRadius){var pixel=document.createElement("div");pixel.setAttribute('class','pixel');pixel.style.height=height+"px";pixel.style.width="1px";pixel.style.position="absolute";pixel.style.fontSize="1px";pixel.style.overflow="hidden";var topMaxRadius=this.spec.get('tR');pixel.style.backgroundColor=colour;if(image&&this.backgroundImage!=""){pixel.style.backgroundImage=this.backgroundImage;pixel.style.backgroundPosition="-"+(this.boxWidth-(cornerRadius-intx)+this.borderWidth)+"px -"+((this.boxHeight+topMaxRadius+inty)-this.borderWidth)+"px";}
...
return fraction;}
curvyObject.rgb2Array=function(rgbColour){var rgbValues=rgbColour.substring(4,rgbColour.indexOf(")"));return rgbValues.split(/,\s*/);}
