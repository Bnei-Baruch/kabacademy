	...
	<div id="tabs">
		...
		<div id="mainContent">
			<div id="home">
				...
				<div class="divider"></div>
				<div class="divider"></div>
				<h1>Регистрация продлится до 31 декабря<br />СЕЙЧАС ЗНАЧИТЕЛЬНЫЙ МОМЕНТ В ТВОЕЙ ЖИЗНИ. ВЫБОР ЗА ТОБОЙ!</h1>
				<div id="signup">
					<a
			...
			<div id="course-description" class="subpage">
				<div id="what-in-course">
					...
					<ul>
						<li>Продолжительность 1-го семестра базового курса “Основы каббалы” - 10 недель. По четвергам мы выставляем на страницу студента и высылаем вам урок, включающий лекции, тесты, дополнительные материалы и возможность задать вопросы преподавателям. По средам проходит вебинар, на котором преподаватели объясняют трудные аспекты темы занятия и отвечают на ваши вопросы. Во время вебинара вы можете задавать вопросы. Видеозапись вебинара выставляется в архив.</li>
						<li>Продолжительность 2-го семестра - 10 недель.</li>
						<li>По итогам обучения 21 мая конференция в нескольких городах (предположительно в Москве, Екатеринбурге и Одессе).</li>
						<li>По завершении обучения вы получите диплом выпускника Международной академии каббалы.</li>
					</ul>
