	...
	<div id="tabs">
		...
		<div id="mainContent">
			<div id="home">
				...
				<div class="divider"></div>
				<div class="divider"></div>
				<h1>Начало обучения 5 апреля<br />СЕЙЧАС ЗНАЧИТЕЛЬНЫЙ МОМЕНТ В ТВОЕЙ ЖИЗНИ. ВЫБОР ЗА ТОБОЙ!</h1>
				<div id="signup">
					<a
			...
			<div id="course-description" class="subpage">
				<div id="what-in-course">
					...
					<ul>
						<li>Продолжительность 1-го семестра базового курса “Основы каббалы” - 10 недель. По средам мы выставляем на страницу студента и высылаем вам урок, включающий лекции, тесты, дополнительные материалы и возможность задать вопросы преподавателям. По четвергам проходит вебинар, на котором преподаватели объясняют трудные аспекты темы занятия и отвечают на ваши вопросы. Во время вебинара вы можете задавать вопросы. Видеозапись вебинара выставляется в архив.</li>
