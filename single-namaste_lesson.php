...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); ?>
        <!-- 	<?php if (!get_post_meta(get_the_ID(), "qode_show-page-title", true)) { ?>
					<div class="title <?php if ($responsive_title_image == 'no' && $title_image != "" && $fixed_title_image == "yes" && $show_title_image == true) {
            ...
            if ($responsive_title_image == 'no' && $title_height != '') {
                echo 'height:' . $title_height . 'px;';
            }
            if ($title_background_color != '') {
                echo 'background-color:' . $title_background_color . ';';
            } ?>">
						<?php if ($responsive_title_image == 'yes' && $title_image != "" && $show_title_image == true) {
                echo '<img src="' . $title_image . '" alt="title" />';
            } ?>
        ...
        <?php if (($sidebar == "default") || ($sidebar == "")) : ?>
            <div class="blog_holder v2 blog_single single-namaste_lesson">
		...
		-->
                    <div class="post_content_holder width100">
                        ...
                        <div class="post_text<?php if (!has_post_thumbnail()) {
                            echo " no_image";
                        } ?>">
                            <div class="inner">
                                <?php $course_id = get_post_meta($post->ID, 'namaste_course', true); ?>
                                ...
                                <h2 class="u3h2"><a href="<?php the_permalink(); ?>"
                                ...
                                <?php if (has_tag()) { ?>
                                    <div
                                        class="blog_single_tags"><?php the_tags(__('Tags > ', 'qode')); ?></div><?php } ?>
                            </div>
                        </div>
                    </div>
                </div>
