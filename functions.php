...
function request_url() {
	$result = ''; // �?Ÿ�?¾�?º�?° Ñ€�?µ�?·Ñƒ�?»ÑŒÑ‚�?°Ñ‚ �?¿ÑƒÑ�Ñ‚
	$default_port = 80; // �?Ÿ�?¾Ñ€Ñ‚ �?¿�?¾-Ñƒ�?¼�?¾�?»Ñ‡�?°�?½�?¸ÑŽ
	                    
	// �?� �?½�?µ �?² �?·�?°Ñ‰�?¸Ñ‰�?µ�?½�?½�?¾�?¼-�?»�?¸ �?¼Ñ‹ Ñ��?¾�?µ�?´�?¸�?½�?µ�?½�?¸�?¸?
	if (isset ( $_SERVER ['HTTPS'] ) && ($_SERVER ['HTTPS'] == 'on')) {
		// �?’ �?·�?°Ñ‰�?¸Ñ‰�?µ�?½�?½�?¾�?¼! �?�?�?¾�?±�?°�?²�?¸�?¼ �?¿Ñ€�?¾Ñ‚�?¾�?º�?¾�?»...
		$result .= 'https://';
		// ...�?¸ �?¿�?µÑ€�?µ�?½�?°�?·�?½�?°Ñ‡�?¸�?¼ �?·�?½�?°Ñ‡�?µ�?½�?¸�?µ �?¿�?¾Ñ€Ñ‚�?° �?¿�?¾-Ñƒ�?¼�?¾�?»Ñ‡�?°�?½�?¸ÑŽ
		$default_port = 443;
	} else {
		// �?ž�?±Ñ‹Ñ‡�?½�?¾�?µ Ñ��?¾�?µ�?´�?¸�?½�?µ�?½�?¸�?µ, �?¾�?±Ñ‹Ñ‡�?½Ñ‹�?¹ �?¿Ñ€�?¾Ñ‚�?¾�?º�?¾�?»
		$result .= 'http://';
	}
	// �?˜�?¼Ñ� Ñ��?µÑ€�?²�?µÑ€�?°, �?½�?°�?¿Ñ€. site.com �?¸�?»�?¸ www.site.com
	...
	// �?Ÿ�?¾Ñ��?»�?µ�?´�?½Ñ�Ñ� Ñ‡�?°Ñ�Ñ‚ÑŒ �?·�?°�?¿Ñ€�?¾Ñ��?° (�?¿ÑƒÑ‚ÑŒ �?¸ GET-�?¿�?°Ñ€�?°�?¼�?µÑ‚Ñ€Ñ‹).
				...
				<a href="' . get_permalink ( $post->ID ) . '">
					<span class="academy_course_text">
							...
							<span class="academy_course_subtitle">
								...
								<span class="btnCourse">�?—�?°�?¿�?¸Ñ��?°Ñ‚ÑŒÑ�Ñ�</span>
							</span>
...
<div class="single_topic_reply" data-id="<?php echo $reply->ID; ?>">
	...
	<div class="content_wrapper">
		...
		<div style="display: none" class="reply_content_edit">
			...
			<div class="edit_actions">
				<a class="cancel" href="#">�?žÑ‚�?¼�?µ�?½�?¸Ñ‚ÑŒ</a>
			</div>
		</div>
	...
	<div class="addi_actions" style="display: none">
		<ul>
			<li><a class="edit_action" href="#">�? �?µ�?´�?°�?ºÑ‚�?¸Ñ€�?¾�?²�?°Ñ‚ÑŒ</a></li>
			<li><a class="remove_action" href="#">�?£�?´�?°�?»�?¸Ñ‚ÑŒ</a></li>
		</ul>
	</div>
            <?php endif; ?>
        </div>
...
;
				...
				?><a href="#" class="load_all_replies"><i class="comments_img"></i>�?ŸÑ€�?¾Ñ��?¼�?¾Ñ‚Ñ€�?µÑ‚ÑŒ
                            �?µÑ‰�?µ <?php echo $count . ' ' . custom_plural_form($count, '�?º�?¾�?¼�?¼�?µ�?½Ñ‚�?°Ñ€�?¸�?¹', '�?º�?¾�?¼�?¼�?µ�?½Ñ‚�?°Ñ€�?¸Ñ�', '�?º�?¾�?¼�?¼�?µ�?½Ñ‚�?°Ñ€�?¸�?µ�?²'); ?>
                            </a>
                        <?php
			}
		...
		<div class="single_topic_reply_form">
			<form
				...
				<div class="reply-form">
					<textarea
						placeholder="<?php _e('�?’�?²�?µ�?´�?¸Ñ‚�?µ Ñ‚�?µ�?ºÑ�Ñ‚ Ñ��?¾�?¾�?±Ñ‰�?µ�?½�?¸Ñ�...', 'qode'); ?>"
...
<?php
		...
		;
		if ($counter == 11) {
			?><a class="load_more_topics" href="#">�?ŸÑ€�?¾Ñ��?¼�?¾Ñ‚Ñ€�?µÑ‚ÑŒ
	�?±�?¾�?»ÑŒÑˆ�?µ �?¾�?±Ñ�Ñƒ�?¶�?´�?µ�?½�?¸�?¹</a>
<?php
		}
	}
...
function upload_forum_file() {
	...
	if ($type == 'post') {
		...
		$content = '<div class="single_topic_single_attachment">
				...
				'32',
				'32' 
		) ) . '</a></div><div class="attachment-controls"><a class="delete-attachment" data-id="' . $attachment_id . '" href="#">�?£�?´�?°�?»�?¸Ñ‚ÑŒ</a></div>
            </div>';
	} else {
		if ($id != 0) {
