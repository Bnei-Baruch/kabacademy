...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400,300italic,300,400italic,700,700italic&subset=cyrillic,cyrillic-ext,latin,greek-ext,greek,vietnamese,latin-ext' rel='stylesheet' type='text/css'>
	<!--[if gte IE 9]>
		<style type="text/css">
			.gradient {
				 filter: none;
...
<body <?php body_class(); ?>>
	...
	<?php //$userid = get_current_user_id(); print_r(get_user_meta(get_current_user_id())); ?> 
		...
		<?php if($header_in_grid){ ?>
				<div class="container">
					...
					<?php
						$navOptions = array( 
							...
							if(is_user_logged_in()){
								$navOptions['menu'] = 'Header right menu (Signed)';
							} else{
								$navOptions['menu'] = 'Header right menu (Unsigned)';
							}
					...
					<nav class="mobile_menu">
						<?php			
						$navMobileOptions = array( 'theme_location' => 'top-navigation' , 
																	'container'  => '', 
																	'container_class' => '', 
																	'menu_class' => '', 
																	'menu_id' => '',
							...
							if(is_user_logged_in()){
								$navMobileOptions['menu'] = 'Header right menu (Signed)';
							} else{
								$navMobileOptions['menu'] = 'Header right menu (Unsigned)';
							}						
						
							wp_nav_menu( $navMobileOptions);
						?>
					</nav>
					</div>
				</div>
